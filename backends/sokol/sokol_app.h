...
EMSCRIPTEN_KEEPALIVE void _sapp_emsc_invoke_fetch_cb(int index, int success, int error_code, _sapp_html5_fetch_callback clipboard, uint32_t fetched_size, void* buf_ptr, uint32_t buf_size, void* user_data) {
